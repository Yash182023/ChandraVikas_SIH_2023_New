...
# #         top = 0
# #         left = 0
# #         img = tifffile.imread(os.path.join(src, filename))  # Use tifffile to read TIFF images
# #         for top in range(0, image_size, 24):
# #             for left in range(0, image_size, 24):
# #                 patch_image = img[top:top + 24, left:left + 24, ...]
# #                 newname = filename[:-4] + "_" + str(int(top / 24) + 1) + "_" + str(int(left / 24) + 1) + ".tiff"  # Change the file extension
# #                 filepath = os.path.join(dst, filename[:-4], newname)
# #                 tifffile.imwrite(filepath, patch_image)  # Use tifffile to write TIFF images
# #     print("Cropping done!")
...
# #         merged_image = np.zeros(shape=(image_size, image_size, 3))
# #         for idx, filename in enumerate(natsorted(os.listdir(folder))):
# #             image = tifffile.imread(os.path.join(folder, filename))  # Use tifffile to read TIFF images
# #             # ... (Rest of the code remains the same)
# #             # Save image
# #             tifffile.imwrite(os.path.join(dst, merged_filename), merged_image)  # Use tifffile to write TIFF images
# #     print("Merging done!")
